...
he explanation of the TPB model is very dependent on the selected prediction model (MVR in our case). This means that models with little or no explanation power (black boxes) are of less interest in a TPB.% event if they could be applied and they would gain a higher prediction accuracy.
